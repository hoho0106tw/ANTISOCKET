...
using System.Threading;
    public partial class NotifyWindow : Form
    {
        ...
        public void Notify()
        {
            ...
            SetWindowPos(Handle, HWND_TOPMOST, rScreen.Width - ActualWidth - 11, rScreen.Bottom, ActualWidth, 0, SWP_NOSIZE);
        ...
        private  void SetTimer(Boolean isenable)
        {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (textPressed)
                ...
                useColor = TextColor;
            using (SolidBrush sb = new SolidBrush(useColor))          
                e.Graphics.DrawString(Text.Replace("admin",""), useFont, sb, rText, this.StringFormat);
        }
        ...
        protected const Int32 HWND_NOTOPMOST = -2;
        protected const Int32 SWP_NOACTIVATE = 0x0010;
        protected const Int32 SWP_NOSIZE = 0x0001;
        // ShowWindow()
        protected const Int32 SW_SHOWNOACTIVATE = 4;

           protected const Int32  SW_HIDE=0;
         protected const Int32 SWP_HIDEWINDOW = 0x0080;
